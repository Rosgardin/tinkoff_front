...
(function onLoad(){
  ...
  if (!items) {
    const items = [
        {
            title: "Дракоша",
            img: "https://samara.ko-snegiri.ru/upload/iblock/312/ogvd1hob4lxfnhp85kg9frs0dztuqloz.jpg",
            body: "Подарок игрушка",
            id: 1,
            deliever: "Снегири",
          },
          {
            title: "Дракоша поменьше",
            img: "https://samara.ko-snegiri.ru/upload/iblock/274/vxjdbz69y6prit2blqthflq0x1yfzmc8.jpg",
            body: "Подарок игрушка поменьше",
            id: 2,
            deliever: "Снегири",
          },
    ];
